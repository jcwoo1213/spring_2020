          ...
          <div class="form-three widget-shadow">
            <form class="form-horizontal" action="modify" method="post" enctype="multipart/form-data">
              <div class="form-group">
                ...
                <div class="col-sm-8">
                  <input  type="text" class="form-control1" id="disabledinput" name="idx" value="${board.idx}" readonly>
                </div>
              </div>
              <div class="form-group">
                <label for="disabledinput" class="col-sm-2 control-label">제목</label>
                <div class="col-sm-8">
                  <input  type="text" class="form-control1"  placeholder="Title:" name="title" idx="title" value="${board.title}">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-8">
                  <textarea name="content" id="txtarea1" cols="20" rows="20" class="form-control1">${board.content}</textarea>
                </div>
              </div>
