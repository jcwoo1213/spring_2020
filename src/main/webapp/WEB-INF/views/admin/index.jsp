...
<script src="../resources/admin/js/pie-chart.js" type="text/javascript"></script>
...
<!-- //pie-chart --><!-- index page sales reviews visitors pie chart -->
	...
	<!-- requried-jsfiles-for owl -->
					<link href="../resources/admin/css/owl.carousel.css" rel="stylesheet">
...
<body class="cbp-spmenu-push">
    ...
    <script src="../resources/admin/js/Chart.bundle.js"></script>
	...
	<script src="../resources/admin/js/SimpleChart.js"></script>
    <script>
        var graphdata1 = {
            linecolor: "#CCA300",
            title: "Monday",
