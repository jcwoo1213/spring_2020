          ...
          <div class="form-three widget-shadow">
            <form class="form-horizontal" method="post" action="modify">
              <div class="form-group">
                ...
                <div class="col-sm-8">
                  <input  type="text" class="form-control1" id="disabledinput" name="idx" value="<c:out value="${notice.idx}"/>" readonly>
                </div>
              </div>
              <div class="form-group">
                <label for="disabledinput" class="col-sm-2 control-label">제목</label>
                <div class="col-sm-8">
                  <input  type="text" class="form-control1" id="disabledinput" name="title" placeholder="Title:" value="<c:out value="${notice.title}"/>">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-8">
                  <textarea  name="content" id="txtarea1" cols="20" rows="20" class="form-control1">${notice.content}</textarea>
                </div>
              </div>
              <input type='hidden' name='writer' value='<c:out value="${notice.writer}"/>'>
